        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">캠퍼스 통합 플랫폼</p>
            </div>
          </div>
          <Button 
            variant="campus" 
            onClick={() => setIsLoginOpen(true)}
            className="shadow-campus-lg"
          >
            로그인
          </Button>
        </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              가톨릭대학교 학생과 교직원을 위한 통합 플랫폼입니다. 
              캠퍼스 지도 기반으로 실시간 정보를 공유하고, 
              더 편리한 대학생활을 만들어보세요.
            </p>
            <Button 
              variant="campus" 
              size="xl" 
              onClick={() => setIsLoginOpen(true)}
              className="shadow-campus-lg hover:scale-105 transition-all duration-300"
            >
              시작하기
            </Button>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <Card key={index} className="shadow-campus hover:shadow-campus-lg transition-campus border-card-border">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <p className="text-sm text-muted-foreground">
              © 2024 Catholic University of Korea. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
